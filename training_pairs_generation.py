...
class pairs():
	...
	def split_list_into_two_textfiles(self, pairsList):
		txtFileLeft = ""
		txtFileRight = ""
		random.shuffle(pairsList)	# shuffle list of pairs
		for line in pairsList:
			txtFileLeft+= line[0]+" "+line[2]+"\n"
			txtFile2Right+= line[1]+" "+line[2]+"\n"
		fLeft = open('./txtFileLeft.txt','w')
		fLeft.write(txtFileLeft)
		fLeft.close()
		fRight = open('./txtFileRight.txt','w')
		fRight.write(txtFileRight)
		fRight.close()
